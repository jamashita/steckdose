...
export class StatusCodes {
  ...
  public static readonly MOVED_TEMPORARILY = 302 as const;
  ...
  public static readonly REQUEST_TOO_LONG = 413 as const;
  public static readonly REQUEST_URI_TOO_LONG = 414 as const;
  public static readonly UNSUPPORTED_MEDIA_TYPE = 415 as const;
  public static readonly REQUESTED_RANGE_NOT_SATISFIABLE = 416 as const;
  public static readonly EXPECTATION_FAILED = 417 as const;
  public static readonly IM_A_TEAPOT = 418 as const;
  public static readonly INSUFFICIENT_SPACE_ON_RESOURCE = 419 as const;
